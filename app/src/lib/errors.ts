export const STABLE_ERROR = {
  ...
  ADMISSION_WEIGHTS_INVALID: 'ADMISSION_WEIGHTS_INVALID',
  ADMISSION_PASS_PERCENT_INVALID: 'ADMISSION_PASS_PERCENT_INVALID',
  ADMISSION_SCORE_INVALID: 'ADMISSION_SCORE_INVALID',
  ADMISSION_EXAM_NOT_FOUND: 'ADMISSION_EXAM_NOT_FOUND',
