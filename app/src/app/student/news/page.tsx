...
export default function StudentNewsPage() {
  ...
  return (
    <DashboardLayout
      ...
      breadcrumbs={['Alumno', 'Noticias']}
    >
      <div className="flex items-center gap-4 mb-8">
        <h1 className="text-2xl font-bold text-gray-900">Noticias</h1>
        <span className="px-3 py-1 bg-violet-100 text-violet-800 rounded-full text-sm font-bold">
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-bold text-gray-900 mb-1 group-hover:text-violet-700 transition-colors">{row.title}</h3>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4" onClick={() => setSelected(null)}>
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-xl overflow-hidden" onClick={e => e.stopPropagation()}>
            <div className="px-6 py-5 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
              <span className="px-2.5 py-1 bg-violet-100 text-violet-800 text-xs font-bold rounded-lg">Noticia</span>
