                ...
                {staff.map(s => (
                  <tr key={s.id} className="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-right">
                      <button className="text-gray-400 hover:text-brand-accent p-2 rounded-lg hover:bg-brand-bg transition-colors" title="Ver Perfil">
                        <span className="material-symbols-outlined text-xl">visibility</span>
                      </button>
                      <button
                        onClick={() => handleCreateInvitation(s.id)}
                        className="text-gray-400 hover:text-brand-primary p-2 rounded-lg hover:bg-brand-secondary transition-colors"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden flex flex-col">
            ...
            <div className="p-6 flex-1">
              <form id="staff-form" onSubmit={(e) => e.preventDefault()} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-primary bg-white transition-all"
                  />
                </div>
