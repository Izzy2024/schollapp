...
export default function TeacherMessagesPage() {
  ...
  return (
    <DashboardLayout roleTitle="Docente" userName="Docente" userRole="Docente" menuGroups={menuGroups} breadcrumbs={['Docente', 'Mensajes']}>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-1" title="Bandeja" extra={<Button onClick={refreshInbox}>Refrescar</Button>}>
          ...
          <List
            ...
            renderItem={(item) => (
              <List.Item onClick={() => openConversation(item.conversationId)} className="cursor-pointer">
                <List.Item.Meta
                  title={
