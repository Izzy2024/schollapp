      ...
      <div className="w-full max-w-[1600px] h-[96vh] bg-[#F0F0F0] rounded-3xl shadow-2xl flex overflow-hidden border border-white/50 relative">
        ...
        >
          ...
          <div className="flex items-center justify-between mb-10">
            <Link href="/" className="flex items-center gap-3 no-underline">
              {branding.logoUrl ? (
                ...
                <div className="w-10 h-10 bg-brand-primary text-white rounded-xl flex items-center justify-center shadow-lg flex-shrink-0">
                  ...
                  return (
                    ...
                    >
                      ...
                      {sidebarOpen && item.badge && (
                        <span className="ml-auto flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-brand-primary rounded-full">
                          {item.badge}
                        </span>
                      )}
                    </Link>
          ...
          <div className="mt-auto pt-4 relative group">
            ...
            >
              <div className="w-10 h-10 bg-brand-secondary text-brand-accent rounded-full flex items-center justify-center font-bold text-sm flex-shrink-0">
