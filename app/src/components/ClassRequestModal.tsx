          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-5">
            <div>
              ...
              <select
                ...
                required
                className="w-full h-11 px-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary bg-slate-50 text-slate-700 outline-none transition-all"
              >
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full p-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary bg-slate-50 text-slate-700 outline-none transition-all resize-none"
              ></textarea>
            </div>
